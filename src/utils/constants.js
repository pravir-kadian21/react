...
export const LOGO_URL =
  "https://icon-library.com/images/order-food-online-icon/order-food-online-icon-5.jpg";

export const RESTAURANT_IMG_BASE_URL =
  "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/";

export const MENU_API =
  "https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=28.437331393708693&lng=77.30141635984182&restaurantId=";

export const DISH_IMG_BASE_URL =
